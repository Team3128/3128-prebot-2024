 ...
 */
public class Controller1 extends ControllerBase1 {
     ...
     */
    public Controller1(PIDFFConfig config, Type type, double period) {
        super(config, period);
        this.type = type;
    }
     ...
     * @param type The type of setpoint used by the controller
     */
    public Controller1(PIDFFConfig config, Type type) {
